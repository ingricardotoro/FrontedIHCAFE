...
function TableCost(props) {
    ...
    return ( <
        div >
        <
        RowCardsProjects aprobado = { total_aprobado }
            ...
            budgetLines.map((budgetLine) => ( <
...

                {
                    budgetLine.status === 'Aprobado' ? ( <
                        ...
                        td >
                        <
                        label className = "text-info" > { formatMoney(budgetLine.buddgetstart) } <
                        /label> <
                        /td> <
                        td >
                        <
                        ...
                        td >
                        <
                        label className = "text-danger" > { formatMoney(budgetLine.balance) } <
                        /label> <
                        /td>
                ...
                div className = "modal-header" >
                <
                h5 className = "modal-title" > { budgetLine.name } <
                /h5> <
                ...
                Descripción: { ' ' } { budgetLine.description } <
                /p>
                ...
                <
                ModalVerFiles budget_id = { budget_id }
                idProject = { idProject }
                ...
                div className = "modal-header" >
                <
                h4 className = "modal-title" > { budgetLine.name } - { formatMoney(budgetLine.balance) } { ' ' } <
                /h4> <
                button type = "button"
                className = "close"
                data - dismiss = "modal"
                ...
                data - dismiss = "modal" >
                Cerrar <
                /button> { /* <button type="button" onClick={ () =>this.onClickSubirArchivo(budgetLines.id )} className="btn btn-primary waves-effect waves-light ">Guardar</button> */ } <
                button type = "submit"
                className = "btn btn-primary waves-effect waves-light " >
                Guardar <
                /button> <
        ...
        <
        select onChange = { onChanceCategory }
        name = "select"
        className = "form-control mt-3" >
        <
        ...
        div style = {
            { width: '33%', display: 'inline-block' } } >
        <
        select onChange = { onChanceClasificacion }
        name = "select"
        className = "form-control mt-3" >
        <
