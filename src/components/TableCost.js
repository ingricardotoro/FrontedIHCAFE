...
export default class TableCost extends Component {
    ...
    async componentDidMount(){
        ...
        const res = await axios.post('localhost:4000/api/budgetlines/project/'+this.props.idProject);
        this.setState({budgetLines:res.data.budgetLines});

        const res2 = await axios.post('localhost:4000/api/budgetlines/cat_project/'+this.props.idProject);
