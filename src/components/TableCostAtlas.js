...
function TableCostAtlas(props) {
  ...
  const getData = async () => {
    ...
    const res = await axios.post(
      'https://167.99.15.83:4000/api/budgetlines/atlas/project/' + idProject
    );
  ...
  const onClickSubirArchivo = async (id) => {
    ...
    if (fileData !== null && nombre_archivo !== '') {
      ...
      await axios
        .post('https://167.99.15.83:4000/api/files/atlas/', formDataFile)
        .then((dataResult) => {
  ...
  const onSubmit = async (e) => {
    ...
    /*const res = await axios.post(
            "https://167.99.15.83:4000/api/budgetlines/budgetlineatlas", data
            //"localhost:4000/api/budgetlines/budgetlineatlas", data

        );*/

    await axios
      .post('https://167.99.15.83:4000/api/budgetlines/budgetlineatlas', data)
      .then((dataResult) => {
        //volvemos a traer los budgtines
        getData();
        //cerramos el modald de create New
                              ...
                              {budgetLinesAtlas.statu === 'Aprobado' ? (
                                <>
                                  ...
                                  <td>
                                    <label className="text-info">
                                      {' '}
                                      {formatMoney(budgetLinesAtlas.balance)}
                                    </label>
                                  </td>
                                </>
                              ) : (
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <form>
                                      <div class="modal-body">
                                        ...
                                        <select
                                          onChange={onchangeSelectAprobar}
                                          name="select"
