...
export default class TabBudget extends Component {
  ...
  async calculo2(project_id) {
    ...
    const res = await axios.post(
      'https://167.99.15.83:4000/api/budgetlines/project/' + project_id
    );
    ...
    const res_bud = await axios.post(
      'https://167.99.15.83:4000/api/budgetlines/atlas/project/' + project_id
    );
  ...
  onDelete = async (e) => {
    //e.preventDefault();
    const res_p = await axios.post(
      'https://167.99.15.83:4000/api/budgets/delete/' + this.props.id
    );
                ...
                <div className="card-header">
                  ...
                  <div>
                    <BudgetCard
                      ...
                      neuvoTotalAprobado={this.state.nuevoTotalAprobado}
                      neuvoTotalEjecutado={this.state.nuevoTotalEjecutado}
                    />
