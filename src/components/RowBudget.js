...
export default class RowBudget extends Component {
    ...
    async componentDidMount() {
        ...
        const res = await axios.post('http://167.99.15.83/api/budgetlines/project/category/' + this.props.idProject + '/' + this.props.idCat);
        this.setState({ budgetLines: res.data.budgetLinesCat });

        const res3 = await axios.post('http://167.99.15.83/api/categories/categoriesbyid/' + this.props.idCat);
    ...
    onSubmitAprobar = async (budgetLine_id) => {
        ...
        //const res_aprobar = await axios.post('http://167.99.15.83/api/budgetlines/aprobar/'+budgetLine_id+'/'+this.state.aprobar);
    }
