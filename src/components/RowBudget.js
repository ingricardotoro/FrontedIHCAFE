...
export default class RowBudget extends Component {
  ...
  async componentDidMount() {
    ...
    const res = await axios.post(
      'https://167.99.15.83:4000/api/budgetlines/project/category/' +
    ...
    const res3 = await axios.post(
      'https://167.99.15.83:4000/api/categories/categoriesbyid/' +
        this.props.idCat
    );
  ...
  onSubmitAprobar = async (budgetLine_id) => {
    //e.preventDefault();
    //const res_aprobar = await axios.post('https://167.99.15.83:4000/api/budgetlines/aprobar/'+budgetLine_id+'/'+this.state.aprobar);
  };
                ...
                >
                  ...
                  <tbody>
                      ...
                      <tr key={budgetLine.id}>
                        ...
                        <td>
                          <label className="text-info">
                            {' '}
                            {this.formatMoney(budgetLine.buddgetstart)}
                          </label>
                        </td>
                        <td>
                          <label className="text-danger">
                            {' '}
                            {this.formatMoney(budgetLine.buddgetfinal)}
                          </label>
                        </td>
                        <td>
                            ...
                            <div class="modal-content">
                              ...
                              <form>
                                <div class="modal-body">
                                  <select
                                    onChange={this.onchangeSelectAprobar}
                                    name="select"
                    ...
                    <tr>
                      ...
                      <td>
                        <label className="text-info">
                          {this.formatMoney(this.state.total_inicial)}
                        </label>
                      </td>
                      <td>
                        <label className="text-danger">
                          {this.formatMoney(this.state.total_ejecutado)}
                        </label>
                      </td>
                      <td>
                        <label className="text-success">
                          {this.formatMoney(this.state.total_disponible)}
                        </label>
                      </td>
                      <td align="center">
                        <label>---</label>
                    ...
                    <tr>
                      ...
                      <td>
                        <label>
                          {this.formatMoney(this.state.total_solicitado)}
                        </label>
                      </td>
                      <td align="center">
