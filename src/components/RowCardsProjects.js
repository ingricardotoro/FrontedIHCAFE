            ...
            <div>
                ...
                <div className="col-md-12 col-xl-3">
                    ...
                    <div className="card-header">
                        ...
                        <p className="p-t-10 m-b-0 text-muted">Total de Presupuesto Inicial Aprobado</p>
                        </div>
                    </div>
                    <div className="card-block">
                        <i className="icofont icofont-presentation-alt st-icon bg-primary" />
                        <div className="text-left">
                        <h3 className="d-inline-block"> {this.formatMoney(this.props.inicial)} </h3>
                        <p>
                ...
                <div className="col-md-6 col-xl-3">
                    ...
                    <div className="card-header">
                        ...
                        <p className="p-t-10 m-b-0 text-muted">Total del Presupuesto ejecutado</p>
                        </div>
                    </div>
                    <div className="card-block">
                        <i className="icofont icofont-presentation-alt st-icon bg-danger txt-lite-color" />
                        <div className="text-left">
                        <h3 className="d-inline-block">{this.formatMoney(this.props.ejecutado)}</h3>
                        <p>
                ...
                <div className="col-md-6 col-xl-3">
                    ...
                    <div className="card-block">
                        ...
                        <div className="text-left">
                        <h3 className="d-inline-block">{this.formatMoney(this.props.disponible)}</h3>
                        <p>
