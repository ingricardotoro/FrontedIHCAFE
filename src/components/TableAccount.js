...
export default class TableAccount extends Component {
    ...
    async componentDidMount() {
        ...
        /*const res = await axios.post('http://167.99.15.83/api/budgetlines/project/'+this.props.idProject);
        this.setState({budgetLines:res.data.budgetLines});

        const res2 = await axios.post('http://167.99.15.83/api/budgetlines/cat_project/'+this.props.idProject);
        ...
        const res4 = await axios.get('http://167.99.15.83/api/categories/categories_parents/');
