        ...
        return ( <
            ...
            tbody > {
                this.state.budgetLinesAtlas.map(
                    (budgetLinesAtlas) => ( <
                        tr key = { budgetLinesAtlas.id } > { /* {this.suma(budgetLinesAtlas.buddgetstart, budgetLinesAtlas.buddgetfinal,budgetLinesAtlas.balance)}  */ }
                        ...
                        td className = "pro-name" >
                        <
                        h6 > { budgetLinesAtlas.atlas_account.name } <
                        /h6> <
                        /td> {
                        ...
                        textarea onChange = { this.onchangeComentario }
                        name = "comentario"
                        ...
                        <
                        ModalVerFilesAtlas budget_id = { this.props.budget_id }
                        ...
                        data - dismiss = "modal" >
                        Cerrar <
                        /button> { /* <button type="button" onClick={ () =>this.onClickSubirArchivo(budgetLinesAtlas.id )} class="btn btn-primary waves-effect waves-light ">Guardar</button> */ } <
                        button type = "submit"
                        class = "btn btn-primary waves-effect waves-light " >
                        Guardar <
                        /button> <
            ...
            select onChange = { this.onChanceResultAtlas }
            ...
            select onChange = { this.onChanceProductAtlas }
            ...
            select onChange = { this.onChanceActivityAtlas }
            ...
            select onChange = { this.onChanceAccountAtlas }
            ...
            select onChange = { this.onChanceSubAccountAtlas }
