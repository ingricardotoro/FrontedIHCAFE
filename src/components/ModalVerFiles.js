...
export default class ModalVerFiles extends Component {
    ...
    async componentDidMount(){
        ...
        const res_files = await axios.post('localhost:4000/api/files/filesbybudgetid/'+this.props.budgetlineatlas);
                                                    ...
                                                    <div className="card-block">
                                                        <div className="media">
                                                            <a className="media-left" href="#">
                                                                <img style={{width:'200px'}} className="img-thumbnail " src={'http://localhost:4000/'+file.filedir + file.filename} />
                                                            </a>
                                                            <div className="media-body">
                                                                <div className="col-xs-12">
                                                                    ...
                                                                    <a href = {'http://localhost:4000/'+file.filedir + file.filename}>DESCARGAR </a>
