...
export default class Projectcard extends Component {
    ...
    render() {
        ...
        return ( <
            ...
            className = "card-title" > { this.props.name } <
            /Link> <
            Link to = { '/project/edit/' + this.props.id }
            className = "btn btn-sm btn-warning f-right   " >
            { ' ' }
            Editar { ' ' } <
            /Link> { /* <span className="label label-danger f-right">  {this.props.enddate} </span> */ } <
            span className = "label label-primary f-right" > { ' ' } { this.props.startdate } { ' ' } <
            /span> <
            /div> <
            ...
            strong className = "label label-info" > { this.props.location } { ' ' } <
            /strong> <
            strong > Estatus: < /strong> <
            strong className = "label label-danger" > { this.props.status } { ' ' } <
            /strong> <
            strong > Prioridad: < /strong> <
            strong className = "label label-warning" > { this.props.priority } { ' ' } <
            /strong> <
            /p> <
            /div> { /* end of col-sm-8 */ } <
            /div> { /* end of row */ } <
            ...
            tr >
            <
            td > Presupuesto Aprobado < /td> { /* <td>{this.formatMoney(this.state.total_inicial)}</td> */ } <
            td > { this.formatMoney(this.state.nuevoTotalAprobado) } < /td> { /* <td>{this.formatMoney(this.state.total_Solicitado)}</td> */ } <
            /tr> <
            tr >
            <
            ...
            a href = "#!" >
            <
            img className = "img-fluid img-circle"
