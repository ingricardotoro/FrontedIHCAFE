...
export default class Coinlist extends Component {
  ...
  onSubmitDelete = async (id) => {
    const res_p = await axios.post(
      'https://167.99.15.83:4000/api/coins/delete/' + id
    );
                                      ...
                                      <tr key={coin.id}>
                                        <td className="pro-list-img">
                                          <img
                                            width="80px"
                                            src={
                                              'assets/images/moneda/moneda2.jpg'
                                            }
                                            className="img-fluid"
                                            alt="tbl"
                                          />
