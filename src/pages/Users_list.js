...
export default class Users_list extends Component {
  ...
  async componentDidMount() {
    ...
    const res = await axios.get('https://167.99.15.83:4000/api/users/');
    this.setState({ users: res.data.users });

    //traemos los tipo de usuarios de la tabla tipousuario
    const res2 = await axios.get('https://167.99.15.83:4000/api/tipousers/');
  ...
  onSubmit = async (e) => {
    ...
    const resp = await axios.post(
      'https://167.99.15.83:4000/api/users/register',
      {
  ...
  onSubmitDelete = async (id) => {
    const res_p = await axios.post(
      'https://167.99.15.83:4000/api/users/delete/' + id
    );
    window.location.href = '/users_list';
