...
export default class Account_list extends Component {
    ...
    render() {
        return ( <
            ...
            th > Nombre < /th> <
            th > Moneda < /th> <
            th > Descripción < /th> { /* <th>Balance Actual</th> */ } <
            th > Usuario < /th> { /* <th>Historial</th> */ } <
            th > Eliminar < /th> <
            /tr> <
            /thead> <
            tbody > {
                this.state.accounts.map((account) => ( <
                    ...
                    img width = "80px"
                    src = {
                        'assets/images/accounts/bank.jpg'
                    }
                    className = "img-fluid"
                    alt = "tbl" /
                    >
                    ...
                    <
                    td > { account.user.name } { ' ' } { account.user.lastname } { ' ' } <
                    /td>
                    ...
                    Eliminar Cuenta Monetaria: { ' ' } { account.name } { ' ' } <
                    /h4> <
                    button type = "button"
                    className = "close"
                    data - dismiss = "modal"
