...
export default class Dashboard extends Component {
    ...
    async componentDidMount() {
        ...
        try {
            ...
            const res_budgetsAtlas = await axios.get("http://localhost:4000/api/budgets/atlas");
        ...
        onChangeSelectProject_Atlas = async (e) => {
            ...
            const res2 = await axios.get("http://localhost:4000/api/budgetlines/atlas/grafica_atlas_by_project/" + projectid);
            this.setState({ ArrayGraficabyProject: res2.data.ArrayGraficabyProject });
