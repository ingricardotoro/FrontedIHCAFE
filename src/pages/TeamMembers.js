...
export default class TeamMembers extends Component {
    ...
    async componentDidMount() {
        ...
        const res2 = await axios.get('http://localhost:4000/api/teammembers/' + this.state.team.id);
    ...
    onChangeUser = (e) => { this.setState({ person_id: e.target.value }) }
    onChangeRole = (e) => { this.setState({ role_id: e.target.value }) }
                                        ...
                                        <div className="col-sm-12">
                                            ...
                                            <div className="card product-add-modal">
                                                <div className="card-header">
                                                    <h5>Miembros del Equipo:" {this.state.team.name} "</h5>

                                                    <div className="product-add-modal">

                                                        <button type="button" data-toggle="modal" data-target={"#modal_add_" + this.state.team.id} className="btn btn-success waves-effect waves-light f-right d-inline-block md-trigger" > <i className="icofont icofont-plus m-r-5" /> Agregar Nuevo Miembro
                                                        </button>
                                                                        ...
                                                                        {this.state.teammembers.map(member =>
                                                                            <tr key={member.id}>
                                                                                <td className="pro-list-img">
                                                                                    <img width="80px" src={"../assets/images/teams/avatar-5.png"} className="img-fluid" alt="tbl" />
                                                                                </td>
                                                                                <td>{this.state.team.name}</td>
                                                                                <td>{member.user.name} {member.user.lastname}</td>
                                                                                ...
                                                                                <td><button type="button" data-toggle="modal" data-target={"#modal_delete_" + member.id} className="btn btn-danger waves-effect" >Eliminar</button></td>
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    >
                                                                                        <div className="form-group row">
                                                                                            <label className="col-sm-2 col-form-label">Seleccione Miembro</label>
                                                                                            <div className="col-sm-10">
                                                                                                <select onChange={this.onChangeUser} name="select" className="form-control">
                                                                                        ...
                                                                                        <div className="form-group row">
                                                                                            <label className="col-sm-2 col-form-label">Seleccione Rol</label>
                                                                                            <div className="col-sm-10">
                                                                                                <select onChange={this.onChangeRole} name="select" className="form-control">
                                                                                                    <option value="#">Seleccionar...</option>
                                                                                                    {
