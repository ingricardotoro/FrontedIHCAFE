        ...
        return ( <
            ...
            tbody > {
                this.state.teammembers.map((member) => ( <
                    ...
                    td > { member.user.name } { ' ' } { member.user.lastname } <
                    /td> <
                    td > { member.role.role_name } < /td> { /* <td> <Link to={'/teammembers/' + team.id} ><button type="button" className="btn btn-primary waves-effect" >Ver Miembros</button></Link></td> */ } <
                    td >
                    <
                    button type = "button"
                    data - toggle = "modal"
                    ...
                    Eliminar Miembro del Equipo: { ' ' } { member.user.name } - { member.user.lastname } { ' ' } <
                    /h4> <
                    button type = "button"
                    className = "close"
                    data - dismiss = "modal"
            ...
            <
            h4 className = "modal-title" >
            Agergar Miembro al Equipo: { ' ' } { this.state.team.name } { ' ' } <
            /h4>
