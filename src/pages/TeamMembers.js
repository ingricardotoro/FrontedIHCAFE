...
export default class TeamMembers extends Component {
  ...
  onSubmitDelete = async (id) => {
    const res_p = await axios.post(
      'https://167.99.15.83:4000/api/teammembers/delete/' + id
    );

    window.location.replace('');
    //window.location.href = "https://167.99.15.83/teammembers/" + this.state.team.id;
  ...
  onSubmitAddMember = async (e) => {
    ...
    //e.preventDefault();
    await axios.post('https://167.99.15.83:4000/api/teammembers', {
