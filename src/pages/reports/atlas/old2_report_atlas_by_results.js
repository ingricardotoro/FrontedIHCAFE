...
class TabladeProductos extends Component {
    ...
    async componentDidMount() {
        ...
        const res = await axios.get(
            "http://167.99.15.83/api/atlas/productos/" + this.props.code_resultado
        )
    ...
    /*fetch('http://167.99.15.83/api/atlas/productos/' + this.props.code_resultado, { signal: this.abortController.signal })
            .then((response) => {
        return response.json()
    })
    .then((recurso) => {
