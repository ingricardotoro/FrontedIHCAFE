...
export default class TabladeActividades extends Component {
    ...
    async componentDidMount() {
        ...
        /*fetch('https://167.99.15.83:4000/api/atlas/productos/' + this.props.code_producto)
                .then((response) => {
    ...
    render() {
        return ( <
            ...
            <
            td style = {
                { border: '1px solid' } } > Descripción < /td> <
            td style = {
                { border: '1px solid' } } > ATLAS < /td> <
            td style = {
                { border: '1px solid' } } > Q1 < /td> <
            td style = {
                { border: '1px solid' } } > Ejec < /td> <
            td style = {
                { border: '1px solid' } } > Q2 < /td> <
            td style = {
                { border: '1px solid' } } > Ejec < /td> <
            td style = {
                { border: '1px solid' } } > Q3 < /td> <
            td style = {
                { border: '1px solid' } } > Ejec < /td> <
            td style = {
                { border: '1px solid' } } > Q4 < /td> <
            td style = {
                { border: '1px solid' } } > Ejec < /td> <
            /tr> {
                this.state.activities.map((Activity) => ( <
                    ...
                    <
                    td style = {
                        { border: '1px solid' } } > { Activity.code } - { Activity.name } - { Activity.code_atlas } <
                    /td>

                    <
                    ResultadoByProyect key = { Activity.id }
