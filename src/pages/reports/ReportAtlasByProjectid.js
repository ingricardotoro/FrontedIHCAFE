        ...
        return ( <
            ...
            tbody > {
                this.state.ArrayReportebyProject.map((Item) => ( <
                    ...
                    <
                    td style = {
                        { border: '1px solid' } } > { Item.atlas_account.code } { ' ' } <
                    /td> <
                    td style = {
                        { border: '1px solid' } } > { Item.atlas_account.name } <
                    /td> <
                    td style = {
                        { border: '1px solid' } } > { this.formatMoney(Item.inicial) } <
                    /td> <
                    td style = {
                        { border: '1px solid' } } > { this.formatMoney(Item.TOTAL) } <
                    /td> <
                    /tr>
                ))
            } <
