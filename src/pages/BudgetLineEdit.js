...
export default class BudgetLineEdit extends Component {
    ...
    async componentDidMount() {
        ...
        const res = await axios.post(
            "http://167.99.15.83/api/budgetlines/findone/" + this.props.match.params.projectId + "/" + this.props.match.params.id
        );
        ...
        this.setState({ sub_category_code: this.state.budgetLine.sub_category_code })
    ...
    onChanceClasificacion = async (e) => {
        ...
        const res7 = await axios.get(
            "http://167.99.15.83/api/categories/child/" + e.target.value
        );
    ...
    onSubmitEdit = async (e) => {
        ...
        await axios.put("http://167.99.15.83/api/budgetlines/update/" + this.props.match.params.projectId + "/" + this.props.match.params.id, {
                            ...
                            <div className="page-header page-wrapper mt-3 ">
                                ...
                                <div className="page-header-breadcrumb">
                                    <ul className="breadcrumb-title">
                                        ...
                                        <li className="breadcrumb-item">
                                            <Link to={"/project/" + this.props.match.params.projectId}>Ver Presupuestos</Link>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                                    ...
                                                                    <div >
                                                                        <div className="modal-header">
                                                                            <h4 className="modal-title">
                                                                                Editar Presupuesto: {" "}
                                                                                {this.state.budgetLine.name}{" "}
                                                                            </h4>

                                                                        </div>
                                                                        <div className="modal-body">

                                                                            {/* <input name type="hidden" classname="form-control mt-3" defaultValue="{this.props.idProject}/" /> */}
                                                                            <div className=" mt-3">
                                                                                <div style={{ width: "50%", display: "inline-block" }}>
                                                                                    ...
                                                                                    >
                                                                                        <option value={this.state.category_id}>Seleccione Categoria</option>
                                                                                ...
                                                                                <div style={{ width: "50%", display: "inline-block" }}>
                                                                                    <select
                                                                                        ...
                                                                                        className="form-control mt-3"
                                                                                    >
                                                                                        <option value={this.state.sub_category_code}>
                                                                            ...
                                                                            <div className=" mt-3">
                                                                                <div style={{ width: "50%", display: "inline-block" }}>
                                                                                    <select
                                                                                        ...
                                                                                        className="form-control mt-3"
                                                                                    >
                                                                                        <option value={this.state.account_id}>Seleccione Cuenta de Origen</option>
                                                                                ...
                                                                                <div style={{ width: "50%", display: "inline-block" }}>
                                                                                    <select
                                                                                        ...
                                                                                        className="form-control mt-3"
                                                                                    >
                                                                                        <option value={this.state.supplier_id}>
