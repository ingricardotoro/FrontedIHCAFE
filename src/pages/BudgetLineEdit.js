...
export default class BudgetLineEdit extends Component {
    ...
    async componentDidMount() {
        ...
        const res = await axios.post(
            "http://localhost:4000/api/budgetlines/findone/" + this.props.match.params.projectId + "/" + this.props.match.params.id
        );
    ...
    onChanceClasificacion = async (e) => {
        ...
        const res7 = await axios.get(
            "http://localhost:4000/api/categories/child/" + e.target.value
        );
    ...
    onSubmitEdit = async (e) => {
        ...
        await axios.put("http://localhost:4000/api/budgetlines/update/" + this.props.match.params.projectId + "/" + this.props.match.params.id, {
