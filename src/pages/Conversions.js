...
export default class TeamMembers extends Component {
  ...
  async componentDidMount() {
    ...
    const res = await axios.get(
      'https://167.99.15.83:4000/api/coins/' + this.props.match.params.id
    );
    this.setState({ coin: res.data.coin });

    //obtenemos las conversiones de esta moneda
    const res2 = await axios.get(
      'https://167.99.15.83:4000/api/conversions/' + this.state.coin.id
    );
  ...
  onSubmitDelete = async (id) => {
    const res_p = await axios.post(
      'https://167.99.15.83:4000/api/conversions/delete/' + id
    );
    window.location.replace('');
    //window.location.href = "https://167.99.15.83/conversions/" + this.state.coin.id;
  ...
  onSubmitAddValue = async (e) => {
    //e.preventDefault();
    await axios.post('https://167.99.15.83:4000/api/conversions', {
