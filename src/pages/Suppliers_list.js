        ...
        return ( <
            ...
            tbody > {
                this.state.suppliers.map((supplier) => ( <
                    ...
                    Eliminar Proveedor: ({ supplier.company }) - { supplier.contact_name } <
                    /h4> <
                    button type = "button"
                    className = "close"
                    data - dismiss = "modal"
            ...
            <
            textarea onChange = { this.onChangeAddress }
            rows = { 5 }
            cols = { 5 }
            className = "form-control"
            ...
            div style = {
                { marginTop: 15 } } >
            <
            label > Datos del Contácto < /label> <
            /div> <
            div style = {
                {
                    width: '50%',
            ...
            <
            input required onChange = { this.onChangeContactName }
            class = "form-control "
            type = "text"
