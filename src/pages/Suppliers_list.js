...
export default class Supliers_list extends Component {
  ...
  async componentDidMount() {
    ...
    const res = await axios.get('https://167.99.15.83:4000/api/suppliers/');
  ...
  onSubmit = async (e) => {
    e.preventDefault();
    const resp = await axios.post('https://167.99.15.83:4000/api/suppliers', {
  ...
  onSubmitDelete = async (id) => {
    const res_p = await axios.post(
      'https://167.99.15.83:4000/api/suppliers/delete/' + id
    );
    window.location.href = '/suppliers_list';
