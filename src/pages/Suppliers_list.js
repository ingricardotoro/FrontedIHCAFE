...
export default class Suppliers_list extends Component {
                                ...
                                <div className="page-body">
                                    <div className="card product-add-modal">
                                        <div className="card-header">
                                            ...
                                            <button type="button" className="btn btn-primary waves-effect waves-light f-right d-inline-block md-trigger" data-toggle="modal" data-target="#modal-13"> <i className="icofont icofont-plus m-r-5" /> Nuevo Proveedor
                                </button>
                                        </div>
                                        ...
                                        <div className="modal fade" tabIndex={-1} role="dialog" id="modal-13">

                                            <div className="modal-dialog" role="document">
                                                <div className="modal-content">
                                                    <h3 className="f-26">Nuevo Proveedor</h3>
                                                    <div>
