...
export default class ReportsAtlas extends Component {
    ...
    async componentDidMount() {
        ...
        const res_atlas = await axios.get("http://167.99.15.83/api/budgets/atlas");
    ...
    onChangeSelectBudget_Atlas = async (e) => {
        ...
        const res_pro_atlas = await axios.post(
            "http://167.99.15.83/api/projects/findProjectsByBudgetId/" +
            e.target.value
        );
        ...
        this.state.projects_atlas.map(async (p_atlas) => {
            ...
            const res = await axios.post(
                "http://167.99.15.83/api/budgetlines/atlas/project/" + p_atlas.id
            );
    ...
    onChangeSelectProject_Atlas = async (e) => {
        ...
        const res_pro_atlas = await axios.post(
            "http://167.99.15.83/api/budgetlines/atlas/reporte_atlas_by_project/" +
            e.target.value
        );
                                ...
                                <div className="page-body">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <Link to={'reports/atlas_by_project_id/' + this.state.project_id + '/' + this.state.coin_id} className="btn btn-block btn-success" > Vista Previa de Reporte </Link>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <select
                                                                                    onChange={this.onChangeSelectAccountAtlas}
                                                                                    className="form-control mb-3"
                                                                                    name="anio"
                                                                                >
                                                                                    <option value="0">
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <Link to={
                                                                                    ...
                                                                                    + this.state.coin_id + '/'
                                                                                    + this.state.year
                                                                                } className="btn btn-block btn-success" > Vista Previa de Reporte </Link>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                    ...
                                    <div className="row">
                                        <div className="col-sm-12">
                                            ...
                                            <div className="card product-add-modal">
                                                <div className="card-header">
                                                    <h5>Reportes Por Resultados, Productos y Actividades</h5>
                                                </div>
                                                <div className="card-block">
                                                    <div className="table-responsive">
                                                        <div className="table-content">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <label>Crear Reporte</label>
                                                                                {/* <button className="btn btn-block btn-primary" onClick={this.reporte_atlas_by_project} type="primary"> Generate PDF </button> */}
                                                                                <Link to={'reports/atlas/report_atlas_by_results/' + this.state.budget_atlas_id + '/' + this.state.coin_id + '/' + this.state.year} className="btn btn-block btn-primary" > Vista Previa de Reporte </Link>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
