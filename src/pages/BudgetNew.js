...
export default class BudgetNew extends Component {
    ...
    async componentDidMount() {
        ...
        const res7 = await axios.get('https://167.99.15.83:4000/api/coins/');
    ...
    onSubmit = async(e) => {
        e.preventDefault();
        const res = await axios.post('https://167.99.15.83:4000/api/budgets', {
    ...
    render() {
        return ( <
            ...
            div className = "col-sm-10" >
            <
            input onChange = { this.onChangeStart }
            class = "form-control"
            type = "date"
            ...
            div className = "col-sm-10" >
            <
            input onChange = { this.onChangeEnd }
            class = "form-control"
            type = "date"
            ...
            /option> {
                this.state.cuentas.map((cuenta) => ( <
                    ...
                    ({ cuenta.coin.code } - { cuenta.actualbalance }) - { cuenta.name } { ' ' } <
                    /option>
                ))
            } <
            /select> <
            ...
            div className = "col-sm-10" >
            <
            select onChange = { this.onChangeCoin }
            name = "select_coin"
            className = "form-control mt-3" >
            <
            option value = "#" >
            ...
            div className = "col-sm-10" >
            <
            select onChange = { this.onChangeTipo }
            name = "select_tipo"
            className = "form-control mt-3" >
            <
            option value = "#" >
