...
export default class CoinNew extends Component {
    ...
    onSubmit = async(e) => {
        e.preventDefault();
        await axios.post('https://167.99.15.83:4000/api/coins/', {
    ...
    render() {
        return ( <
            ...
            /li> <
            li className = "breadcrumb-item" > Crear Nueva Moneda < /li> <
            /ul> <
            /div> <
            /div> <
            ...
            placeholder = "Ingrese Nombre de Moneda" /
            >
            <
            /div> <
            /div>
            ...
            required type = "text"
            className = "form-control"
            placeholder = "Ingrese Símbolo de Moneda" /
            >
            <
            /div> <
            /div>
